...
const RegularProduct = ({router}) => {
  ...
  return (
    <div className='bg-[white] rounded-md flex items-center justify-center flex-col py-3 md:mb-4 md:w-[370px] w-[90%] cursor-pointer' onClick={()=>router.push('/products/1')}>
